...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tree_scripts.topLevelItem(0).setText(0, _translate("MainWindow", "檔案"))
        self.tree_scripts.topLevelItem(0).child(0).setText(0, _translate("MainWindow", "存檔"))
        self.tree_scripts.topLevelItem(0).child(1).setText(0, _translate("MainWindow", "讀檔"))
        self.tree_scripts.topLevelItem(1).setText(0, _translate("MainWindow", "滑鼠"))
        self.tree_scripts.topLevelItem(1).child(0).setText(0, _translate("MainWindow", "點擊滑鼠"))
        self.tree_scripts.topLevelItem(1).child(1).setText(0, _translate("MainWindow", "滾動滑鼠"))
        self.tree_scripts.topLevelItem(1).child(2).setText(0, _translate("MainWindow", "移動滑鼠"))
        self.tree_scripts.topLevelItem(2).setText(0, _translate("MainWindow", "鍵盤"))
        self.tree_scripts.topLevelItem(2).child(0).setText(0, _translate("MainWindow", "點擊按鈕"))
